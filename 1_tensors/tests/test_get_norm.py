...
def test_get_norm():
    ...
    inputs = get_norm(p=1.5, num_points=5)
    truths = [np.array([[-10., -5., 0., 5., 10.],
                        [-10., -5., 0., 5., 10.],
                        [-10., -5., 0., 5., 10.],
                        [-10., -5., 0., 5., 10.],
              ...
              np.array([[-10., -10., -10., -10., -10.],
                        ...
                        [5., 5., 5., 5., 5.],
                        [10., 10., 10., 10., 10.]]),
              np.array([[15.87401052, 12.23630407, 10., 12.23630407, 15.87401052],
                        [12.23630407, 7.93700526, 5., 7.93700526, 12.23630407],
                        [10., 5., 0., 5., 10.],
                        [12.23630407, 7.93700526, 5., 7.93700526, 12.23630407],
                        [15.87401052, 12.23630407, 10., 12.23630407, 15.87401052]])]
    for inp, tru in zip(inputs, truths):
        np.testing.assert_allclose(inp, tru, err_msg="Norm computation is not implemented correctly.")
